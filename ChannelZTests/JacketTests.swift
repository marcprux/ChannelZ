...
//        dump(dir)
        ...
        do {
            ...
            bebeZ.workAddressZ.coalesce({ defaddr }).line1Z.$ = "AAA"
            bebeZ.workAddressZ.coalesce({ defaddr }).line2Z.$ = "BBB"
            ...
            let a2 = bebeZ.workAddressZ.coalesce({ defaddr }).line1Z.sieve(!=).new()

            let b1 = bebeZ.homeAddressZ.line2Z.sieve(!=).new()
            let b2 = bebeZ.workAddressZ.coalesce({ defaddr }).line2Z.sieve(!=).new()
            ...
            bebeZ.workAddressZ.coalesce({ defaddr }).line1Z.$ = "ZZZ"
            ...
            bebeZ.previousAddressesZ.index(2).coalesce({ defaddr }).line1Z.$ = "XYZ"
            XCTAssertEqual(3, bebeZ.$.previousAddresses.count)
            XCTAssertEqual(["XYZ", "XYZ", "XYZ"], bebeZ.$.previousAddresses.map({ $0.line1 }))

            bebeZ.previousAddressesZ.index(1).coalesce({ defaddr }).line1Z.$ = "ABC"
